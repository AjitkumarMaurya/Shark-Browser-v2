...
import ajit.browser.focus.utils.RecyclerViewTestUtils.clickChildViewWithId
...
class BookmarkRobot : MenuRobot() {
    ...
    fun checkBookmarkUpdatedToastIsDisplayed(activity: ajit.browser.focus.activity.MainActivity) = ajit.browser.focus.utils.AndroidTestUtils.toastContainsText(activity, R.string.bookmark_edit_success)
}