...
open class MenuRobot {
    ...
    /** Open menu **/
    fun clickHomeMenu() = ajit.browser.focus.utils.AndroidTestUtils.tapHomeMenuButton()

    fun clickBrowserMenu() = ajit.browser.focus.utils.AndroidTestUtils.tapBrowserMenuButton()
