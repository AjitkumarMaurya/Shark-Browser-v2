...
import ajit.browser.focus.helper.CountChildViewMatcher;
import ajit.browser.focus.helper.GetNthChildViewMatcher;
import ajit.browser.focus.helper.GetTextViewMatcher;
...
public class SearchSuggestionTest {
     ...
     */
    @Test
    public void clickSearchSuggestion_browseByDefaultSearchEngine() throws UiObjectNotFoundException {
