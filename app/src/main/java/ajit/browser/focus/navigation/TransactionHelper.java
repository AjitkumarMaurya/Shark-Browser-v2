...
package ajit.browser.focus.navigation;
...
import static ajit.browser.focus.navigation.ScreenNavigator.BrowserScreen;
import static ajit.browser.focus.navigation.ScreenNavigator.FIRST_RUN_FRAGMENT_TAG;
import static ajit.browser.focus.navigation.ScreenNavigator.HOME_FRAGMENT_TAG;
import static ajit.browser.focus.navigation.ScreenNavigator.HomeScreen;
import static ajit.browser.focus.navigation.ScreenNavigator.URL_INPUT_FRAGMENT_TAG;
...
class TransactionHelper implements DefaultLifecycleObserver {
    ...
    void showUrlInput(@Nullable String url, String sourceFragment) {
        ...
        final Fragment existingFragment = fragmentManager.findFragmentByTag(ScreenNavigator.URL_INPUT_FRAGMENT_TAG);
    ...
    void onUrlInputScreenVisible(boolean visible) {
        ...
        final ScreenNavigator.Screen homeFragment =
                (ScreenNavigator.Screen) fragmentManager.findFragmentByTag(ScreenNavigator.HOME_FRAGMENT_TAG);
        if (homeFragment != null && homeFragment.getFragment().isVisible()) {
            if (homeFragment instanceof ScreenNavigator.HomeScreen) {
                ((ScreenNavigator.HomeScreen) homeFragment).onUrlInputScreenVisible(visible);
            }
        }
    }
    ...
    private static class BackStackListener implements FragmentManager.OnBackStackChangedListener {
        ...
        public void onBackStackChanged() {
            ...
            if (fragment instanceof ScreenNavigator.BrowserScreen) {
        ...
        private void setBrowserForegroundState(boolean isForeground) {
            ...
            FragmentManager manager = this.helper.activity.getSupportFragmentManager();
            ScreenNavigator.BrowserScreen browserFragment = (ScreenNavigator.BrowserScreen) manager.findFragmentById(R.id.browser);
            if (isForeground) {
