...
package ajit.browser.focus.telemetry

import ajit.browser.focus.telemetry.TelemetryWrapper.FIND_IN_PAGE.*
import ajit.browser.focus.telemetry.TelemetryWrapper.Value.SETTINGS
import ajit.browser.lightning.R
import ajit.browser.telemetry.annotation.TelemetryDoc
...
object TelemetryWrapper {
    ...
    fun isTelemetryEnabled(context: Context?): Boolean {
        return if (context == null) {
            ...
            ajit.browser.focus.Inject.isTelemetryEnabled(context)
        }
    }
    ...
    private fun updateDefaultBrowserStatus(context: Context) {
        ajit.browser.focus.utils.Settings.updatePrefDefaultBrowserIfNeeded(context, ajit.browser.focus.utils.Browsers.isDefaultBrowser(context))
    }
    ...
    private fun createDefaultSearchProvider(context: Context): DefaultSearchMeasurement.DefaultSearchEngineProvider {
        return DefaultSearchMeasurement.DefaultSearchEngineProvider {
            ajit.browser.focus.search.SearchEngineManager.getInstance()
    ...
    @TelemetryDoc(
            ...
            value = Value.TURBO,
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.TO, value = "true,false")])
    @JvmStatic
    ...
    @TelemetryDoc(
            ...
            `object` = Object.FIRSTRUN,
            value = Value.FINISH,
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.ON, value = "time spent on First Run")])
    @JvmStatic
    ...
    @TelemetryDoc(
            ...
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.TYPE, value = Extra_Value.TEXT_SELECTION + "," + Extra_Value.WEB_SEARCH)])
    @JvmStatic
    ...
    @TelemetryDoc(
            ...
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.TO, value = "New Value for the pref")])
    @JvmStatic
    fun settingsEvent(key: String, value: String, sendNow: Boolean = false) {
        // We only log whitelist-ed setting
        val validPrefKey = ajit.browser.focus.telemetry.FirebaseEvent.getValidPrefKey(key)
    ...
    @TelemetryDoc(
            ...
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.SOURCE, value = "TurboMode,Telemetry")])
    @JvmStatic
    ...
    @TelemetryDoc(
            ...
            `object` = Object.SETTING,
            value = "pref_locale",
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.TO, value = "Locale "),
                ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.DEFAULT, value = "true,false")])
    @JvmStatic
    ...
    @TelemetryDoc(
            ...
            `object` = Object.TOOLBAR,
            value = Value.CAPTURE,
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.VERSION, value = "ping version"),
                ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.CATEGORY, value = "category name"),
                ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.CATEGORY_VERSION, value = "category version")
            ])
    @JvmStatic
    ...
    @TelemetryDoc(
            ...
            `object` = Object.HOME,
            value = Value.LINK,
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.ON, value = "Top Site Position"),
                ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.ON, value = "Preset Top Site like **")])
    @JvmStatic
    ...
    @TelemetryDoc(
            ...
            `object` = Object.HOME,
            value = Value.LINK,
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.DEFAULT, value = "true,false")])
    @JvmStatic
    ...
    fun searchSelectEvent() {
        ...
        val searchEngine = ajit.browser.focus.search.SearchEngineManager.getInstance().getDefaultSearchEngine(
    ...
    @TelemetryDoc(
            ...
            `object` = Object.SEARCH_BAR,
            value = "",
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.VERSION, value = SEARCHCLEAR_TELEMETRY_VERSION)])
    @JvmStatic
    fun searchClear() {
    ...
    @TelemetryDoc(
            ...
            `object` = Object.SEARCH_BAR,
            value = "",
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.VERSION, value = SEARCHDISMISS_TELEMETRY_VERSION)])
    @JvmStatic
    fun searchDismiss() {
    ...
    @TelemetryDoc(
            ...
            `object` = Object.PANEL,
            value = Value.FILE,
            extras = [(ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.SNACKBAR, value = "true,false"))])
    @JvmStatic
    ...
    @TelemetryDoc(
            ...
            `object` = Object.PANEL,
            value = Value.LIFEFEED_NEWS,
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.POSITION, value = "1,2,3..."),
                ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.FEED, value = "Newspoint,DainikBhaskar.com"),
                ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.SOURCE, value = "India TV,Business World,HW News English...etc"),
                ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.CATEGORY, value = "Uttar Pradesh,National,Tech Knowledge....etc"),
                ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.SUB_CATEGORY, value = "top-news,entertainment,Lucknow...etc")])
    ...
    @TelemetryDoc(
            ...
            value = Value.LIFEFEED_EC,
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.POSITION, value = "1,2,3..."),
                ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.SOURCE, value = "bukalapak,tokopedia"),
                ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.CATEGORY, value = "pulsa,data,game,train,flight,event")])
    ...
    @TelemetryDoc(
            ...
            value = Value.LINK,
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.CATEGORY, value = "category"),
                ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.CATEGORY_VERSION, value = "category version")
            ])
    @JvmStatic
    ...
    @TelemetryDoc(
            ...
            `object` = Object.CAPTURE,
            value = Value.IMAGE,
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.SUCCESS, value = "true,false"),
                ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.CATEGORY, value = "category"),
                ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.CATEGORY_VERSION, value = "category version")
            ])
    @JvmStatic
    ...
    @TelemetryDoc(
            ...
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.SOURCE, value = "contextual_hints,settings,notification")
            ])
    @JvmStatic
    ...
    @TelemetryDoc(
            ...
            `object` = Object.FEEDBACK,
            value = "",
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.SOURCE, value = "notification")])
    @JvmStatic
    ...
    @TelemetryDoc(
            ...
            value = "",
            extras = [
                ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.DELAY, value = "minutes"),
                ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.MESSAGE, value = "message")
            ])
    @JvmStatic
    ...
    @TelemetryDoc(
            ...
            `object` = Object.DEFAULT_BROWSER,
            value = "",
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.SOURCE, value = TelemetryWrapper.Extra_Value.NOTIFICATION),
                ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.VERSION, value = "version")])
    @JvmStatic
    ...
    @TelemetryDoc(
            ...
            value = "dismiss,share",
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.SOURCE, value = "contextual_hints,settings")])
    @JvmStatic
    ...
    @TelemetryDoc(
            ...
            value = "",
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.TO, value = "theme name")])
    @JvmStatic
    ...
    @TelemetryDoc(
            ...
            `object` = Object.THEMETOY,
            value = "",
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.TO, value = "default")])
    @JvmStatic
    ...
    @TelemetryDoc(
            ...
            `object` = Object.PRIVATE_MODE,
            value = "",
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.TO, value = "notification")])
    @JvmStatic
    ...
    @TelemetryDoc(
            ...
            value = Value.NEW,
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.TO, value = "banner page id")])
    @JvmStatic
    ...
    @TelemetryDoc(
            ...
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.SOURCE, value = "page Id")])
    @JvmStatic
    ...
    @TelemetryDoc(
            ...
            `object` = Object.BANNER,
            value = Value.ITEM,
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.SOURCE, value = "pageId"),
                ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.ON, value = "position")])
    @JvmStatic
    ...
    @TelemetryDoc(
            ...
            `object` = Object.BANNER,
            value = Value.PAGE,
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.DIRECTION, value = "direction"),
                ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.TO, value = "position")])
    @JvmStatic
    ...
    @TelemetryDoc(
            ...
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.SOURCE, value = "vpn,wifi_finder")])
    @JvmStatic
    ...
    @TelemetryDoc(
            ...
            value = Value.NEXT,
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.VERSION, value = "2")])
    ...
    @TelemetryDoc(
            ...
            value = "",
            extras = [ajit.browser.telemetry.annotation.TelemetryExtra(name = Extra.ENGINE, value = "Facebook,Youtube,Instagram")])
    @JvmStatic
    ...
    internal class EventBuilder @JvmOverloads constructor(category: String, method: String, `object`: String?, value: String? = null) {
        ...
        companion object {
            ...
            fun lazyInit() {
                ...
                if (ajit.browser.focus.telemetry.FirebaseEvent.isInitialized()) {
                    return
                }
                ...
                ajit.browser.focus.telemetry.FirebaseEvent.setPrefKeyWhitelist(prefKeyWhitelist)
            }
        }
    }
    ...
    private class ThemeToyMeasurement internal constructor(internal var context: Context) : TelemetryMeasurement(MEASUREMENT_CURRENT_THEME) {
        ...
        override fun flush(): Any {
            return ajit.browser.lightning.theme.ThemeManager.getCurrentThemeName(context)
        }
    ...
    private class CaptureCountMeasurement internal constructor(private val context: Context) : TelemetryMeasurement(MEASUREMENT_CAPTURE_COUNT) {
        ...
        override fun flush(): Any {
            ...
            try {
                context.contentResolver.query(ajit.browser.focus.provider.ScreenshotContract.Screenshot.CONTENT_URI, null, null, null, null)!!.use { cursor ->
