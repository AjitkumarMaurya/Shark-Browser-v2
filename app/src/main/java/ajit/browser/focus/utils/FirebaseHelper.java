    ...
    private static void initInternal(final Context applicationContext) {
        ...
        firebaseContract.enableRemoteConfig(applicationContext, () -> {
            ThreadUtils.postToBackgroundThread(() -> {
                ...
                final boolean canOverride = settings.canOverride(NewsSourcePreference.PREF_INT_NEWS_PRIORITY, Settings.PRIORITY_FIREBASE);
                ...
                if (!TextUtils.isEmpty(source) && (canOverride || TextUtils.isEmpty(settings.getNewsSource()))) {
                    ...
                    settings.setPriority(NewsSourcePreference.PREF_INT_NEWS_PRIORITY, Settings.PRIORITY_FIREBASE);
