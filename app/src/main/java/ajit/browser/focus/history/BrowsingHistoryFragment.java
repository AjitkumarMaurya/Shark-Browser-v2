...
import ajit.browser.focus.fragment.ItemClosingPanelFragmentStatusListener;
...
public class BrowsingHistoryFragment extends PanelFragment implements View.OnClickListener, ItemClosingPanelFragmentStatusListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mContainerRecyclerView = v.findViewById(R.id.browsing_history_recycler_view_container);
        mContainerEmptyView = v.findViewById(R.id.empty_view_container);
        mRecyclerView = v.findViewById(R.id.browsing_history_recycler_view);
        return v;
    }
