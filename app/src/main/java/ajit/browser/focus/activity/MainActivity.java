...
import ajit.browser.fileutils.FileUtils;
...
import ajit.browser.focus.fragment.FirstrunFragment;
import ajit.browser.focus.fragment.ListPanelDialog;
import ajit.browser.focus.home.HomeFragment;
import ajit.browser.focus.navigation.ScreenNavigator;
import ajit.browser.focus.notification.NotificationId;
import ajit.browser.focus.notification.NotificationUtil;
import ajit.browser.focus.persistence.BookmarksDatabase;
import ajit.browser.focus.persistence.TabModelStore;
import ajit.browser.focus.provider.DownloadContract;
import ajit.browser.focus.repository.BookmarkRepository;
import ajit.browser.focus.screenshot.ScreenshotGridFragment;
import ajit.browser.focus.screenshot.ScreenshotViewerActivity;
import ajit.browser.focus.tabs.tabtray.TabTray;
...
import ajit.browser.focus.utils.Browsers;
import ajit.browser.focus.utils.Constants;
import ajit.browser.focus.utils.DialogUtils;
import ajit.browser.focus.utils.FormatUtils;
import ajit.browser.focus.utils.IntentUtils;
import ajit.browser.focus.utils.NewFeatureNotice;
import ajit.browser.focus.utils.NoRemovableStorageException;
import ajit.browser.focus.utils.SafeIntent;
import ajit.browser.focus.utils.Settings;
import ajit.browser.focus.utils.ShortcutUtils;
import ajit.browser.focus.utils.StorageUtils;
import ajit.browser.focus.utils.SupportUtils;
import ajit.browser.focus.viewmodel.BookmarkViewModel;
import ajit.browser.focus.web.GeoPermissionCache;
import ajit.browser.focus.web.WebViewProvider;
import ajit.browser.focus.widget.FragmentListener;
import ajit.browser.focus.widget.TabRestoreMonitor;
import ajit.browser.lightning.R;
import ajit.browser.lightning.component.LaunchIntentDispatcher;
...
import ajit.browser.lightning.nightmode.AdjustBrightnessDialog;
import ajit.browser.lightning.privately.PrivateMode;
import ajit.browser.lightning.privately.PrivateModeActivity;
import ajit.browser.lightning.promotion.PromotionModel;
import ajit.browser.lightning.promotion.PromotionPresenter;
import ajit.browser.lightning.promotion.PromotionViewContract;
import ajit.browser.lightning.theme.ThemeManager;
...
public class MainActivity extends BaseActivity implements FragmentListener,
    ...
    protected void onCreate(Bundle savedInstanceState2) {
        ...
        savedInstanceState  = savedInstanceState2;
       checkAppPermissions(savedInstanceState2);

    }

    public void checkAppPermissions(Bundle savedInstanceState) {
    ...
    private void go_next(Bundle savedInstanceState) {
