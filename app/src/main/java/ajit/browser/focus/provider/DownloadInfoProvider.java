...
public class DownloadInfoProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (sUriMatcher.match(uri)) {
            case DownloadContract.CODE:
                ...
                queryBuilder.setTables(DownloadContract.Download.TABLE_DOWNLOAD);
                break;
            default:
    ...
    public String getType(@NonNull Uri uri) {
        ...
        switch (sUriMatcher.match(uri)) {
            case DownloadContract.CODE:
                return DownloadContract.Download.CONTENT_TYPE;
            default:
                throw new IllegalArgumentException("URI: " + uri);
        }
    }
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues contentValues) {
        ...
        switch (sUriMatcher.match(uri)) {
            case DownloadContract.CODE:
                id = sqLiteDatabase.insert(DownloadContract.Download.TABLE_DOWNLOAD, null, contentValues);
                break;
            default:
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)) {
            case DownloadContract.CODE:
                count = sqLiteDatabase.delete(DownloadContract.Download.TABLE_DOWNLOAD, selection, selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("URI: " + uri);
        }
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues contentValues, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)) {
            case DownloadContract.CODE:
                count = sqLiteDatabase.update(DownloadContract.Download.TABLE_DOWNLOAD, contentValues, selection, selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("URI: " + uri);
        }
