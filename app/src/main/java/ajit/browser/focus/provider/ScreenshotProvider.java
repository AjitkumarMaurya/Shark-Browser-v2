...
import ajit.browser.focus.provider.ScreenshotContract.Screenshot;
import ajit.browser.focus.provider.ScreenshotDatabaseHelper.Tables;
...
public class ScreenshotProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)) {
            case SCREENSHOT:
                count = db.delete(ScreenshotDatabaseHelper.Tables.SCREENSHOT, selection, selectionArgs);
                break;
            default:
    ...
    public Uri insert(Uri uri, ContentValues initialValues) {
        ...
        switch (sUriMatcher.match(uri)) {
            case SCREENSHOT:
                ...
                id = db.insert(ScreenshotDatabaseHelper.Tables.SCREENSHOT, null, values);
                break;
            default:
                throw new UnsupportedOperationException("URI: " + uri);
        }
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (sUriMatcher.match(uri)) {
            case SCREENSHOT:
                qb.setTables(ScreenshotDatabaseHelper.Tables.SCREENSHOT);
                break;
            default:
                throw new IllegalArgumentException("URI: " + uri);
        }
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch (sUriMatcher.match(uri)) {
            case SCREENSHOT:
                count = db.update(ScreenshotDatabaseHelper.Tables.SCREENSHOT, values, selection, selectionArgs);
                break;
            default:
                throw new UnsupportedOperationException("URI: " + uri);
        }
