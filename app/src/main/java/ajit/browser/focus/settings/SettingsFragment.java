...
package ajit.browser.focus.settings;
...
import ajit.browser.focus.activity.InfoActivity;
import ajit.browser.focus.activity.SettingsActivity;
import ajit.browser.focus.locale.LocaleManager;
import ajit.browser.focus.locale.Locales;
import ajit.browser.focus.telemetry.TelemetryWrapper;
