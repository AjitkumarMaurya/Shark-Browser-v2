...
package ajit.browser.focus.menu;
...
import ajit.browser.focus.download.GetImgHeaderTask;
...
public class WebContextMenu {
    ...
    public static Dialog show(final boolean inPrivate,
        ...
        final View view = LayoutInflater.from(activity).inflate(R.layout.context_menu, null);
