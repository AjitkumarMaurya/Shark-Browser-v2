package ajit.browser.lightning.nightmode
...
class AdjustBrightnessDialog : ajit.browser.focus.activity.BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ajit.browser.focus.utils.ViewUtils.updateStatusBarStyle(false, window)
    }

    override fun onResume() {
        super.onResume()
        val currentBrightness = ajit.browser.focus.utils.Settings.getInstance(this).nightModeBrightnessValue
    ...
    override fun onPause() {
        ...
        val layoutParams = window.attributes
        ajit.browser.focus.utils.Settings.getInstance(this).nightModeBrightnessValue = layoutParams.screenBrightness
