...
package ajit.browser.rocket.tabs
...
class SessionManagerTest {
    ...
    fun testAddTab1() {
        ...
        val tabId0 = mgr.addTab("url0", ajit.browser.rocket.tabs.utils.TabUtil.argument(null, false, false))
        val tabId1 = mgr.addTab("url1", ajit.browser.rocket.tabs.utils.TabUtil.argument(null, false, false))
        val tabId2 = mgr.addTab("url2", ajit.browser.rocket.tabs.utils.TabUtil.argument(null, false, false))
    ...
    fun testAddTab2() {
        ...
        val tabId2 = mgr.addTab("url2", ajit.browser.rocket.tabs.utils.TabUtil.argument(tabId0, false, false))
    ...
    fun testAddTab3() {
        ...
        val tabId1 = mgr.addTab("url1", ajit.browser.rocket.tabs.utils.TabUtil.argument(null, false, false))
        val tabId2 = mgr.addTab("url2", ajit.browser.rocket.tabs.utils.TabUtil.argument(tabId0, false, false))
        val tabId3 = mgr.addTab("url3", ajit.browser.rocket.tabs.utils.TabUtil.argument(tabId0, false, false))
        val tabId4 = mgr.addTab("url4", ajit.browser.rocket.tabs.utils.TabUtil.argument(tabId1, false, false))
        val tabId5 = mgr.addTab("url5", ajit.browser.rocket.tabs.utils.TabUtil.argument(tabId4, false, false))
    ...
    @Test
    fun testAddTab3A() {
        val tabId0 = mgr.addTab("url", ajit.browser.rocket.tabs.utils.TabUtil.argument(null, false, true))
        val tabId1 = mgr.addTab("url", ajit.browser.rocket.tabs.utils.TabUtil.argument(null, false, true))
        val tabId2 = mgr.addTab("url", ajit.browser.rocket.tabs.utils.TabUtil.argument(tabId1, false, true))
        val tabId3 = mgr.addTab("url", ajit.browser.rocket.tabs.utils.TabUtil.argument(tabId2, false, true))
        // open from external
        val tabId4 = mgr.addTab("url", ajit.browser.rocket.tabs.utils.TabUtil.argument(null, true, false))
        val tabId5 = mgr.addTab("url", ajit.browser.rocket.tabs.utils.TabUtil.argument(tabId4, false, true))
        val tabId6 = mgr.addTab("url", ajit.browser.rocket.tabs.utils.TabUtil.argument(tabId5, false, true))
        val tabId7 = mgr.addTab("url", ajit.browser.rocket.tabs.utils.TabUtil.argument(null, true, false))
        val tabId8 = mgr.addTab("url", ajit.browser.rocket.tabs.utils.TabUtil.argument(tabId7, false, true))
        val tabId9 = mgr.addTab("url", ajit.browser.rocket.tabs.utils.TabUtil.argument(tabId8, false, true))
    ...
    fun testAddTab4() {
        ...
        val tabId0 = mgr.addTab("url0", ajit.browser.rocket.tabs.utils.TabUtil.argument(null, true, false))
        Assert.assertEquals(mgr.focusSession!!.id, tabId0)

        val tabId1 = mgr.addTab("url1", ajit.browser.rocket.tabs.utils.TabUtil.argument(null, false, true))
    ...
    fun testAddTab5() {
        ...
        mgr.register(spy0)
        val tabId0 = mgr.addTab("url0", ajit.browser.rocket.tabs.utils.TabUtil.argument(null, false, true))
        ...
        mgr.register(spy1)
        val tabId1 = mgr.addTab("url1", ajit.browser.rocket.tabs.utils.TabUtil.argument(null, true, false))
        ShadowLooper.runUiThreadTasksIncludingDelayedTasks()
        ...
        mgr.register(spy2)
        mgr.addTab("url2", ajit.browser.rocket.tabs.utils.TabUtil.argument(null, false, false))
        ShadowLooper.runUiThreadTasksIncludingDelayedTasks()
