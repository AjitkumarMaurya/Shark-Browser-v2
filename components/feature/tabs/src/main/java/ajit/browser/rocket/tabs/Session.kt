...
import ajit.browser.rocket.tabs.Session.Observer
...
class Session @JvmOverloads constructor(
    ...
    interface Observer {
        ...
        fun onLongPress(session: Session, hitTarget: ajit.browser.rocket.tabs.TabView.HitTarget) = Unit
         ...
         * full screen mode.
         */
        fun onEnterFullScreen(callback: ajit.browser.rocket.tabs.TabView.FullscreenCallback, view: View?) = Unit
