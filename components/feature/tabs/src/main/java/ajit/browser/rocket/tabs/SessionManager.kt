...
import ajit.browser.rocket.tabs.SessionManager.Factor.FACTOR_BACK_EXTERNAL
import ajit.browser.rocket.tabs.SessionManager.Factor.FACTOR_NO_FOCUS
import ajit.browser.rocket.tabs.SessionManager.Factor.FACTOR_TAB_ADDED
import ajit.browser.rocket.tabs.SessionManager.Factor.FACTOR_TAB_REMOVED
import ajit.browser.rocket.tabs.SessionManager.Factor.FACTOR_TAB_SWITCHED
import ajit.browser.rocket.tabs.SessionManager.Observer
...
class SessionManager @JvmOverloads constructor(
        private val tabViewProvider: ajit.browser.rocket.tabs.TabViewProvider,
    ...
    fun addTab(url: String, arguments: Bundle): String? {
        ...
        return if (TextUtils.isEmpty(url)) {
            null
                ...
                ajit.browser.rocket.tabs.utils.TabUtil.getParentId(arguments),
                ajit.browser.rocket.tabs.utils.TabUtil.isFromExternal(arguments),
                ajit.browser.rocket.tabs.utils.TabUtil.toFocus(arguments),
                arguments)
    }
