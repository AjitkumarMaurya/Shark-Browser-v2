package ajit.browser.fileutils;
...
public class AndroidBundleSerializer {
    ...
    private static class NullHandler implements DataTypeHandler {
        ...
        @Override
        public SerializedItem create(final Bundle bundle, final String key) {
        ...
        @Override
        public void restore(final Bundle bundle, final SerializedItem serializedItem) {
